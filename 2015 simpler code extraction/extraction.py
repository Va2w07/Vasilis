...
def slab2(n):
    return param.logT2(1.0, n, param.kD[0]) - param.T0

def slab2dash(n):
    return param.logT2dash(1.0, n, param.kD[0])
...
def slab4(n):
    return param.logT4(1.0, n, param.kD[0]) - param.T0

def slab4dash(n):
    return param.logT4dash(1.0, n, param.kD[0])
